    ...
    public static void main(String[] args)
        {
            ...
            double doubleOperandB = 5.50;
            double doubleSum = 13.50;
            double doubleProduct = 24.50;
            ...
            System.out.println(" The sum using ints of " + intOperandA + "" + intOperandB + " is " + doubleSum);

            doubleDifference = doubleOperandA - doubleOperandB;
            System.out.println(" The difference using ints of " + intOperandA + "" + intOperandB + " is " + doubleDifference);

            doubleProduct = doubleOperandA * doubleOperandB;
            System.out.println(" The product using ints of " + intOperandA + "" + intOperandB + " is " + doubleProduct);
